...
const Calculator = {
    ...
    Display_Value: '0',
    //this will hold the first operand for any expressions, we it it to null for now
    First_Operand: null,
...
function Input_Decimal (dot) {
    ...
    if(!Calculator.Display_Value.includes(dot)) {
        //we are saying that if the Display_Value does not contain a decimal points
...
function Handle_Operator(Next_Operator) {
    ...
    // when n operator key is pressed, we convert the current number
    ...
    if (First_Operand == null) {
        ...
        // in the perform_Calculation objec and the function that matches the 
